...
def draw_heart(w, h, iteration=0):
    ...
    if iteration == len(colors) - 1:  # Only draw text in the last iteration / hanya gambar teks di iterasi terakhir
        ...
        t.color("black")
        t.setpos(0, 0)
        t.write("miss you f <3", align="center", font=("verdana", 15, "bold"))
        t.down()

colors = ['red', 'white', 'red'] # add more colors if you want / tambahkan warna lain jika diperlukan

# Set up the screen / Setting layar
screen = turtle.Screen()
screen.setup(width=600, height=600)
screen.bgcolor("white")
screen.title("I Miss u - A")
